...
export const modStore = {
  ...
  async loadMods() {
    ...
    try {
      // TODO: Call Tauri command to scan mods
      // const mods = await invoke<ModInfo[]>("scan_mods");
      // this.setMods(mods);
...
export const profileStore = {
  ...
  async loadProfiles() {
    ...
    try {
      // TODO: Call Tauri command to load profiles
  ...
  async switchProfile(id: string) {
    setProfileState("loading", true);
    try {
      // TODO: Call Tauri command to switch profile
